...
class TopHeadlineBySourceViewModelTestModel {
    ...
    fun fetchNewsBySource_whenRepositoryResponseSuccess_shouldSetSuccessUiState() {
        runTest {
            doReturn(flowOf(emptyList<ArticleModel>()))
            ...
            viewModel.uiState.test {
                assertEquals(UiState.Success(emptyList<ArticleModel>()), awaitItem())
    ...
    fun fetchNewsBySource_whenRepositoryResponseError_shouldSetErrorUiState() {
        runTest {
            ...
            doReturn(flow<List<ArticleModel>> {
