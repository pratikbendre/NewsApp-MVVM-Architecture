...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers) {
        ...
        /**
         * Creates a dependency provider for hiltwork (androidx.hilt:hilt-work)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHiltwork() { return create("hiltwork"); }

        /**
         * Creates a dependency provider for hiltworkcompiler (androidx.hilt:hilt-compiler)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHiltworkcompiler() { return create("hiltworkcompiler"); }
        ...
        /**
         * Creates a dependency provider for workruntimektx (androidx.work:work-runtime-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getWorkruntimektx() { return create("workruntimektx"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final HiltWorkVersionAccessors vaccForHiltWorkVersionAccessors = new HiltWorkVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.hilt.work
         */
        public HiltWorkVersionAccessors getWork() { return vaccForHiltWorkVersionAccessors; }
    ...
    public static class HiltWorkVersionAccessors extends VersionFactory  {

        public HiltWorkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: hilt.work.compiler (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCompiler() { return getVersion("hilt.work.compiler"); }
